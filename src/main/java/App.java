...
public class App {
  public static void main(String[] args) {
    ...
    post("/definitions", (request, response) -> {
      ...
      String addDefinition = request.queryParams("addDefinition");
      Definition newDefinition = new Definition(addDefinition);
      word.addDefinition(newDefinition);
      model.put("word", word);
      model.put("template", "templates/word-definitions-added.vtl");
      return new ModelAndView(model, layout);
    }, new VelocityTemplateEngine());
  }
}
